...
public class MockData {
    ...
    public void addMockDataToDatabase(){
        Note koalaNote = new Note("Interessantes ueber Koalabaeren", "Der Koala ist ein " +
                "baumbewohnender Beutelsaeuger in Australien. Er wurde von dem Zoologen Georg " +
                "August Goldfuss im Jahre 1817 als Lipurus cinereus erstbeschrieben. Der Koala ist " +
                "neben dem Kaenguru das am weitesten verbreitete Symbol Australiens.");
        ...
        Note delfinNote = new Note("Delfine", "Die Delfine oder Delphine gehoeren zu " +
                "den Zahnwalen und sind somit Saeugetiere, die im Wasser leben. Delfine sind die" +
                " vielfaeltigste und mit rund 40 Arten groesste Familie der Wale. Sie sind in allen " +
                "Meeren verbreitet.");

        ArrayList<String> delfinTags = new ArrayList<String>();
        koalaTags.add("Saeugetiere");
        ...
        Task besuchMamaPapa1 = new Task("Kueche putzen");
        Task besuchMamaPapa2 = new Task("Bad putzen");
        Task besuchMamaPapa3 = new Task("Zimmer aufraeumen");
        ...
        Todo besuchMamaPapa = new Todo("Besuch von Mama und Papa", "Alles muss sauber und " +
                "aufgeraeumt sein!", besuchMamaPapaTasks);
        ...
        String addressBrings = "Koeln, Tanzbrunnen";
        ...
        Task kuechePutzen1 = new Task("Arbeitsflaeche wischen");
        Task kuechePutzen2 = new Task("Geschirr spuelen");
        Task kuechePutzen3 = new Task("Glaeser einraeumen");

        ArrayList<Task> kuechePutzenTasks = new ArrayList<Task>();
        kuechePutzenTasks.add(kuechePutzen1);
        kuechePutzenTasks.add(kuechePutzen2);
        kuechePutzenTasks.add(kuechePutzen3);

        Todo kuechePutzen = new Todo("Kueche aufraeumen", "Das Backen war ein Fiasko",
                kuechePutzenTasks);

        kuechePutzen.setStartDate(new Date(1550448000000L));
        kuechePutzen.setEndDate(new Date(1551052800000L));
        Update.saveTEN(kuechePutzen);
        kuechePutzen = null;


        Task reiseVorbereitung1 = new Task("Waesche waschen");
        ...
        Note kaenguruNote = new Note("Kaengurus","Kaengurus gelten als typischer Vertreter der Fauna Australiens.");
        ...
        Note melbourneNote = new Note("Melbourne", "Melbourne ist die an der " +
                "Suedostkueste Australiens gelegene Hauptstadt des australischen Bundesstaats " +
                "Victoria. Im Stadtzentrum liegt der moderne Federation-Square-Komplex mit Plaetzen," +
                " Bars und Restaurants am Fluss Yarra. Am suedlichen Flussufer im Kunstbezirk der" +
                " Stadt befinden sich das Arts Centre Melbourne – ein Zentrum fuer darstellende" +
                " Kuenste – und die National Gallery of Victoria, in der Werke von australischen" +
                " Kuenstlern und Aborigines ausgestellt werden.");
        ...
        Note bambusNote = new Note("Bambus", "Bambus ist eine der zwoelf" +
                " Unterfamilien aus der Familie der Suessgraeser, der etwa 116 Gattungen zugerechnet" +
        ...
        Task klausurVorbereitung4 = new Task("uebungsaufgaben Bilanz");
        Task klausurVorbereitung5 = new Task("uebungsaufgaben GuV");
        ...
        Task appProgrammierung6 = new Task("App uebergeben");
